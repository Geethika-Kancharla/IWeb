...
if __name__ == '__main__':
    # Check if required files exist before starting the server
    required_files = [modelConfiguration, modelWeights, labelsPath]
    ...
    if missing_files:
        ...
        print("- yolov3.cfg (Configuration file)")
        print("- yolov3.weights (Pre-trained weights)")
        print("- coco.names (Class labels)")
    else:
        app.run(debug=True)